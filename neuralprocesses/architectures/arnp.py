...
__all__ = ["construct_arnp"]


@register_model
def construct_arnp(*args, nps=nps, num_heads=8, **kw_args):
    """Attentive version of Relational Neural Process.
    ...
    Returns:
        :class:`.model.Model`: ARNP model.
    """
    raise NotImplementedError("ARCNP model is still under construction!")
